...
<div class="row">
    <div class="col-md-6">
        <div class="form-group">
            {!! Form::label('password', transm('admin.password')) !!} <span class="{{!isset($entity) ? 'required' : ''}}"></span>
            <div class="input-group">
    ...
    <div class="col-md-6">
        <div class="form-group">
            {!! Form::label('confirm_password', transm('admin.confirm_password')) !!} <span class="{{!isset($entity) ? 'required' : ''}}"></span>
            <div class="input-group">
                <span class="input-group-addon"><i class="fa fa-lock"></i></span>
