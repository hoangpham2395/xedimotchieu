...
<div class="model_schedule_info w3-row-padding" data-id="{{$id}}">
	<div class="w3-col m12">
		<div class="w3-card w3-round w3-white">
			<div class="w3-container w3-padding">
				<h4 class="w3-opacity">{{transb('posts.schedules')}} <span class="panel_heading">{{(is_numeric($idx) ? $idx + 1 : $idx)}}</span></h4> 
			</div>
			<div class="w3-container w3-padding">
				<div class="row">
					<div class="col-md-6">
					...
					<div class="col-md-6">
						<div class="form-group">
							...
							<div class="input-group select-district" id="district_id_{{$id}}">
								...
								{!! Form::select('district_id[]', array_get($params, 'listDistricts'), null, ['class' => 'form-control select2', 'required' => true, 'placeholder' => transm('schedules.district_id')]) !!}
							</div>
						</div>
					</div>
				</div>
					...
					<div class="col-md-6 bootstrap-timepicker">
						<div class="form-group">
							...
							<div class="input-group date">
								...
								{!! Form::text('time[]', null, ['class' => 'form-control timepicker', 'placeholder' => transm('schedules.time')]) !!}
							</div>
						</div>
					</div>
