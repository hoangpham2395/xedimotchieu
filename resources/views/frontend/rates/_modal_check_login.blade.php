	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-footer">
				<button type="button" data-url="{{route('frontend.login', ['return_url' => route('home.community.detail', ['id' => $postId])])}}" class="btn btn-primary" data-dismiss="modal" onclick="RatesController.redirectLogin(this);">{{transa('login')}}</a>
